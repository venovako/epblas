...
!  ===========
!
!       SUBROUTINE GGBMV(TRANS,M,N,KL,KU,ALPHA,A,LDA,X,INCX,BETA,Y,INCY)
!
!       .. Scalar Arguments ..
!       REAL ALPHA,BETA
...
!> \verbatim
!>
!> GGBMV  performs one of the matrix-vector operations
!>
...
!>
!  =====================================================================
PURE SUBROUTINE GGBMV(TRANS, M, N, KL, KU, ALPHA, A, LDA, X, INCX, BETA, Y, INCY)
...
!
!     .. Parameters ..
  REAL(KIND=BLAS_REAL_KIND), PARAMETER :: ONE = 1.0, ZERO = 0.0
!     ..
!     .. Local Scalars ..
