...
!  ===========
!
!       COMPLEX FUNCTION HDOTU(N,CX,INCX,CY,INCY)
!
!       .. Scalar Arguments ..
!       INTEGER INCX,INCY,N
!       ..
...
!> \verbatim
!>
!> HDOTU forms the dot product of two complex vectors
!>      HDOTU = X^T * Y
!>
!> \endverbatim
!
...
!  =====================================================================
  ...
  COMPLEX(KIND=BLAS_REAL_KIND) :: HDOTU
!     .. Local Scalars ..
  INTEGER :: I, IX, IY
!     ..
  HDOTU = ZERO
