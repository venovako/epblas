...
!
     ...
     IF (INCX .EQ. 1) THEN
        DO J = 1, N
           ...
           IF (NOCONJ) THEN
              DO I = 1, M
                 TEMP = HFMA(A(I,J), X(I), TEMP)
              END DO
           ELSE
              DO I = 1, M
                 TEMP = HFMA(CONJG(A(I,J)), X(I), TEMP)
              END DO
           END IF
     ...
     ELSE
        DO J = 1, N
           ...
           IF (NOCONJ) THEN
              DO I = 1, M
                 TEMP = HFMA(A(I,J), X(IX), TEMP)
                 IX = IX + INCX
              END DO
           ELSE
              DO I = 1, M
                 TEMP = HFMA(CONJG(A(I,J)), X(IX), TEMP)
                 IX = IX + INCX
              END DO
           END IF
           Y(JY) = HFMA(ALPHA, TEMP, Y(JY))
