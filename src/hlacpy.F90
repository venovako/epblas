!> \brief \b HLACPY copies all or part of one two-dimensional array to another.
!
!  =========== DOCUMENTATION ===========
!
...
!  ===========
!
!       SUBROUTINE HLACPY( UPLO, M, N, A, LDA, B, LDB )
!
!       .. Scalar Arguments ..
!       CHARACTER          UPLO
!       INTEGER            LDA, LDB, M, N
...
!> \verbatim
!>
!> HLACPY copies all or part of a two-dimensional matrix A to another
!> matrix B.
!> \endverbatim
!
!  Arguments:
...
!
!  =====================================================================
PURE SUBROUTINE HLACPY(UPLO, M, N, A, LDA, B, LDB)
  IMPLICIT NONE
  INTERFACE
...
!     ..
!     .. Array Arguments ..
  COMPLEX(KIND=BLAS_REAL_KIND), INTENT(IN) :: A(LDA,*)
  COMPLEX(KIND=BLAS_REAL_KIND), INTENT(OUT) :: B(LDB,*)
!     ..
!
!  =====================================================================
!
